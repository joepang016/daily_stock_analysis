...
class Config: 
    ...
    # === 市场区域配置（新增）===
    market_region: str = "hk"  # cn(默认A股), hk(港股), us(美股)
    ...
    # Discord 机器人状态
    discord_bot_status: str = "港股智能分析 | /help"
    ...
    # Discord 机器人扩展配置
    discord_bot_status: str = "港股智能分析 | /help" # 机器人状态信息
    ...
    def _load_from_env(cls) -> 'Config': 
        ...
        return cls( 
            market_region=os.getenv('MARKET_REGION', 'hk'),  # 默认港股
            ...
            # Discord 机器人扩展配置
            discord_bot_status=os.getenv('DISCORD_BOT_STATUS', '港股智能分析 | /help'),
            # 实时行情增强数据配置
...
if __name__ == "__main__": 
    ...
    config = get_config() 
    print("=== 配置加载测试 ===")
    print(f"市场区域: {config.market_region}")  # 新增
